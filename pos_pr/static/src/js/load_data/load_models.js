...
//             ],
//             domain(self) {
//                 return [['id', 'in', self.pos_session.invoice_surcharge_ids]];
//             },
//             loaded(self, invoiceSurcharges) {
//                 self.db.add_invoice_surcharges(invoiceSurcharges);
//             }
//         }
//     ]);
    ...
    PosDB.include({
        init(options) {
            ...
            this.invoice_surcharges = [];
            this.invoice_surcharge_by_id = {};
            this.invoice_surcharge_by_partner = {};
        },
        ...
        add_due_invoices(invoices) {
            _.each(invoices, invoiceJson => {
                ...
                invoice.amount_residual = parseFloat((invoice.amount_residual - invoice.pos_pr_paid_amount).toFixed(2));
...
//         add_invoice_surcharges(invoiceSurcharges) {
//             this.invoice_surcharges = [];
//             _.each(invoiceSurcharges, surchargeJson => {
//                 const surcharge = new posPrModels.SurchargeInvoice(surchargeJson);
// //                 this.invoice_surcharges.push(surcharge);
// //                 this.invoice_surcharge_by_id[surcharge.id] = surcharge;
//                 if (surcharge.partner_id) {
//                     if (!this.invoice_surcharge_by_partner[surcharge.partner_id.id]) {
//                         this.invoice_surcharge_by_partner[surcharge.partner_id.id] = [];
//                     }
//                     this.invoice_surcharge_by_partner[surcharge.partner_id.id].push(surcharge);
//                 }
//             });
//         },
