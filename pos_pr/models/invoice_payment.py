...
class PosPR(models.Model):
    ...
    move_id = fields.Many2one("account.move", "Invoice", domain="[('move_type', '=', 'out_invoice')]")
    ...
    def _create_payment_miscellaneous_move(self, journal_id):
        ...
        payment_miscellaneous_move_id.action_post()
    ...
    def _generate_invoice_discount(self):
        ...
        for invoice_payment_id in payments_with_discounts:
            invoice_receivable_line = invoice_payment_id.move_id.get_receivable_line_ids()
            ...
            credit_note_receivable_line_ids.account_id = invoice_receivable_line.account_id
    ...
    def _build_credit_note_vals(self):
        ...
        discount_product_id = self.company_id.pos_pr_discount_product_id
        ...
        discount_account_id = self.company_id.pos_pr_discount_default_account_id
